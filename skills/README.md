...
```text
$kb-doc-factory 회의에서 확정한 decision "MVP 범위" 기록을 planning decision으로 생성해.
```

Raw → Planning/Decision 변환:

```text
$kb-ingest "40_RAW/YYMMDD - MVP 범위 회의.md"를 근거로 Planning 반영안과 회의에서 실제로 확정된 Decision만 정리해.
```
