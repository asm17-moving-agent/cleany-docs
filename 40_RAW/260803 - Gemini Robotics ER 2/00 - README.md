...
- `40_RAW`에 있는 비공식 조사 기록이며 사람 검토 전이다.
...
| [공식자료 검증](04%20-%20공식자료%20검증.md)                            | 공식 사실과 Cleany 적용 해석 분리      | 검증     |
...
`00`·`01`·`02`·`03`·`05`는 기존 AI 대화 기반 기록을 보존한다. 공식 자료로 확인한
사실과 Cleany 적용 해석의 구분은 `04 - 공식자료 검증`에서 관리한다.
