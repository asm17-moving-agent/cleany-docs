...
| Gemini Robotics ER 2 | 장면, 시간, 물리 맥락을 이해하고 tool, VLA를 호출할 수 있는 cloud embodied-reasoning VLM 후보 |
...
| Manipulation Skill | 좌석 도착 후 arm과 gripper로 수행하는 high-level 물리 작업. 내부에 VLA policy를 포함할 수 있음 |
