...
XLeRobot은 끌리니의 기반 모바일 매니퓰레이터로 기획서에 명시되어 있다. 이동 베이스는 selected Decision에 따라 표준 XLeRobot의 3륜 구성을 그대로 사용하지 않고 4륜 Mecanum custom base를 사용한다. RGB-D, 2D LiDAR, IMU, 매니퓰레이터를 활용해 이동, 인식, 수거, 정돈 작업을 수행하는 플랫폼으로 이해한다.
