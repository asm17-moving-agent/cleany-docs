...
| Jetson Orin NX | ROS 2, sensor, adapter와 로컬 실행 검증 | API 기반 VLM 추론 자체는 수행하지 않음 |
...
Manipulation Skill은 arm과 gripper를 사용한다. safe stop과 e-stop은 두 실행 경로보다
우선하는 controller 및 hardware 경로다.
...
- [260715 - 로봇 프레임 구조](<../30_DECISIONS/Technical/260715 - 로봇 프레임 구조.md>)
